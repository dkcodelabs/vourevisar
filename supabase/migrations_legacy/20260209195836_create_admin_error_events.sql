...
DROP TRIGGER IF EXISTS trigger_update_admin_error_events_updated_at ON admin_error_events;
...
DROP POLICY IF EXISTS "Only owners and admins can view errors" ON admin_error_events;
...
DROP POLICY IF EXISTS "Authenticated users can insert error logs" ON admin_error_events;
...
DROP POLICY IF EXISTS "Only owners and admins can update errors" ON admin_error_events;
