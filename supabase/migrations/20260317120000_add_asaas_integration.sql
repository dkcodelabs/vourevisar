-- Migration: Adicionar integração Asaas e tabelas de cupons
-- Data: 2026-03-17
...
ADD COLUMN billing_type TEXT CHECK (billing_type IN ('PIX', 'CREDIT_CARD', 'BOLETO'));
...
-- Qualquer usuário logado pode ler cupons ativos para validação (ou podemos preferir validar via Edge Function)
-- Vamos permitir leitura pública de cupons ativos, assim o frontend consegue validar.
...
BEGIN
    ...
    -- 4. Inserir uso do cupom (Removida a validação de uso único por usuário)
