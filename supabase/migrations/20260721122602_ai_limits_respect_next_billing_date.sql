...
BEGIN
  ...
  IF v_role IS NOT NULL THEN
    ...
    WHERE user_id = p_user_id AND is_imported = true AND source_id IS NULL
  ...
  IF FOUND THEN
    ...
    ELSIF v_plan = 'free_trial' AND v_status = 'trial'
      AND v_trial_ends_at IS NOT NULL AND v_trial_ends_at > NOW()
    THEN
