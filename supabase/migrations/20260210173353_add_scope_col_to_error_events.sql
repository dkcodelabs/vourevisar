-- 1. Add scope column to admin_error_events
...
-- 2. Update RPC: Log Error with Scope
...
BEGIN
    ...
    ELSE
        ...
        INSERT INTO admin_error_events (
            ...
            metadata, fingerprint, occurrence_count, first_seen_at, last_seen_at, scope
        ) VALUES (
            p_error_id, p_module, p_action, p_user_message, p_technical_message,
            p_code, p_severity, p_retryable, 'new', p_actor_user_id,
            p_metadata, p_fingerprint, 1, now(), now(), p_scope
        );
