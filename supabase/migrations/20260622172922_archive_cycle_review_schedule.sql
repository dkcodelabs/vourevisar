alter table public.user_editais
  add column if not exists cycle_archived_at timestamptz;

comment on column public.user_editais.cycle_archived_at is
  'Momento em que o edital saiu do ciclo. Usado para pausar e deslocar a agenda de revisões na retomada.';
