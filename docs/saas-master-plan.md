...
- [ ] **Conferir retorno completo de Checkout em Safari real.** Em 2026-09-01, Safari abriu a confirmação de e-mail corretamente e preservou a sessão autenticada, redirecionando `/login` ao Painel. Falta somente concluir um Checkout de Teste nesse navegador e confirmar o retorno autenticado; exige enviar as credenciais descartáveis e o cartão de teste ao Supabase/Stripe dentro do Safari. Não há alteração pendente de código.
