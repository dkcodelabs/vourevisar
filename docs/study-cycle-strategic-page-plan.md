...
- [ ] Auditar o badge de tendencia da pagina Revisoes (`Melhorando`, `Piorando`, `Estavel`) antes de tratar como informacao confiavel para o aluno. O sinal precisa provar que usa historico real suficiente, escopo do ciclo ativo e comparacao correta de dificuldade/retencao; se a base for fraca ou ambigua, ocultar ou trocar por estado honesto em vez de mostrar tendencia aparente.
