...
- [x] Manter acesso ao Portal Stripe durante a janela de arrependimento, sem criar segunda ação de cancelamento: em 2026-08-24, a tela passou a exibir `Ver faturas e cartão` junto ao pedido de cancelamento e reembolso. O portal continua limitado a consulta de faturas e atualização de cartão; o único caminho de desistência com reembolso permanece o botão próprio do produto.
