...
- [ ] Notificar o aluno quando a administracao liberar uma cota bonus de IA: registrar a concessao com origem administrativa, exibir aviso na area de notificacoes do aluno e deixar claro que e um credito de cortesia, sem alterar plano, assinatura ou historico de uso. Validar leitura, estado nao lido e comportamento depois do reset.
