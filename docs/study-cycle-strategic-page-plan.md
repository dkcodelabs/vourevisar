...
- [ ] Avaliar desmesclagem manual depois do ciclo ja carregado, em recorte separado: desfazer equivalencia persistida precisa preservar `topic_merges`, `subject_merges`, progresso replicado e historico de revisao sem corromper agenda. Nao misturar com o fluxo inicial de organizacao.
