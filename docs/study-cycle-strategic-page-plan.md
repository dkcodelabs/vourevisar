...
- [x] Manter acesso ao Portal Stripe durante a janela de arrependimento, sem criar segunda ação de cancelamento: em 2026-08-24, a tela passou a exibir `Atualizar cartão` junto ao pedido de cancelamento e reembolso. Nessa janela, o Portal abre somente a atualização da forma de pagamento; as cobranças e os reembolsos permanecem no Histórico financeiro do produto. O único caminho de desistência com reembolso continua sendo o botão próprio do produto.
