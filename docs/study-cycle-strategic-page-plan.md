...
- [ ] Habilitar `Leaked Password Protection` no Supabase Auth e validar cadastro/troca de senha com credencial comprometida. Bloqueado em 2026-08-11: o projeto esta no plano Free e o Dashboard rejeita a configuracao por exigir Supabase Pro ou superior. Nao simular essa protecao no frontend nem alterar o minimo atual de 6 caracteres; retomar somente apos a migracao de plano, ativar o controle remoto e usar uma mensagem neutra no cadastro e na redefinicao, sem informar se a senha foi vazada, comprometida ou recusada por qualquer regra interna.
