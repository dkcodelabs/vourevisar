        ...
        <div className="max-w-[1400px] mx-auto px-6 py-8 sm:px-10 sm:py-10 w-full">
          <header className="flex items-center justify-between mb-10">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex items-center gap-4 pl-5 border-l border-black/10 dark:border-white/10 relative user-menu-container">
                <div 
                  className="flex items-center gap-4 cursor-pointer group"
                  onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}
                >
                  <div className="text-right hidden sm:block">
                    <p className="text-sm font-bold text-content-main tracking-tight group-hover:text-primary transition-colors">Alex Johnson</p>
                  ...
                  {isUserMenuOpen && (
                    ...
                    >
                      <div className="p-2 space-y-1">
                        ...
                        <button className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-secondary hover:bg-secondary/10 rounded-xl transition-all group">
