...
-- Execute este SQL para me dar todas as informações necessárias
-- ========================================
...
-- 8. VERIFICAR SE HÁ CONSTRAINT OU FOREIGN KEYS
SELECT 
  'CONSTRAINTS' as info,
  tc.constraint_name,
  tc.table_name,
...
WHERE tc.table_name IN ('subjects', 'topics', 'user_cycles')
