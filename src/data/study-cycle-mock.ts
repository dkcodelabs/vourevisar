...
export const mockStudyCycleSubjects: StudyCycleSubject[] = [
  {
    id: 'mat-1',
    name: 'Matemática',
    ...
    topics: [
      ...
      { id: 'mat-1-2', name: 'Cálculo Diferencial', reviewStatus: ReviewInterval.REVISED_15D, notes: '', difficulty: Difficulty.MEDIUM, subTopics: [] },
      { id: 'mat-1-3', name: 'Geometria Analítica', reviewStatus: ReviewInterval.REVISED_30D, notes: '', difficulty: Difficulty.MEDIUM, subTopics: [] },
  ...
  },
  {
    ...
    topics: [
      { id: 'hist-1-1', name: 'Brasil Colônia', reviewStatus: ReviewInterval.COMPLETED, notes: '', difficulty: Difficulty.MEDIUM, subTopics: [] },
      { id: 'hist-1-2', name: 'Primeira Guerra Mundial', reviewStatus: ReviewInterval.COMPLETED, notes: '', difficulty: Difficulty.MEDIUM, subTopics: [] },
      { id: 'hist-1-3', name: 'Revolução Francesa', reviewStatus: ReviewInterval.COMPLETED, notes: '', difficulty: Difficulty.MEDIUM, subTopics: [] },
    ],
  },
  {
    id: 'geo-1',
