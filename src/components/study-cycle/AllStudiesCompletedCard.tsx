...
import SubjectReactivationModal from '../study-plan/SubjectReactivationModal';

const AllStudiesCompletedCard: React.FC = React.memo(() => {
  ...
  useEffect(() => {
    ...
    runConfetti();
    intervalRef.current = setInterval(runConfetti, 300);
  ...
  const handleStartNewStudies = useCallback(() => {
    setShowReactivationModal(true);
  }, []);

  const handleViewGeneralReview = useCallback(() => {
...
export default AllStudiesCompletedCard;