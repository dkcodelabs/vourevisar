...
import {
    ...
    Edit2, Database, Sparkles, FileText
} from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="flex h-full flex-col p-4 md:p-5">
                <div className="relative mb-4 min-h-[132px] border-b border-border pb-4 dark:border-white/5">
                        ...
                        <div className="flex min-w-0 flex-col gap-2">
                            ...
                            <div className="min-h-[42px] space-y-1">
                                ...
                                <p className="flex min-w-0 flex-wrap items-center gap-x-1.5 gap-y-1 text-[11px] font-medium text-content-muted">
                                    ...
                                    {metrics.subjectsCount} {metrics.subjectsCount === 1 ? 'matéria' : 'matérias'} • {metrics.totalTopics} {metrics.totalTopics === 1 ? 'tópico' : 'tópicos'}
                        ...
                        {metrics.subjectsCount > 0 ? (
                            <>
                                <button
                                    ...
                                    className="flex h-8 min-w-0 items-center justify-center gap-1.5 rounded-lg border border-border bg-secondary/50 px-2 text-[10px] font-bold text-content-muted transition-colors hover:bg-secondary-strong hover:text-foreground dark:border-white/5 dark:bg-zinc-800/50 dark:hover:bg-zinc-700 dark:hover:text-content-main"
                                >
                                ...
                                <button
                                    ...
                                    className={`relative flex h-8 min-w-0 items-center justify-center gap-1.5 overflow-hidden rounded-lg px-2 text-[10px] font-bold transition-colors disabled:cursor-not-allowed disabled:opacity-80 ${
                            ...
                            <>
                                <button
                                    onClick={onViewSubjects}
                                    className="flex h-8 min-w-0 items-center justify-center gap-1.5 rounded-lg border border-border bg-secondary/50 px-2 text-[10px] font-bold text-content-muted transition-colors hover:bg-secondary-strong hover:text-foreground dark:border-white/5 dark:bg-zinc-800/50 dark:hover:bg-zinc-700"
                                >
                                    <Eye size={13} className="shrink-0" />
                                    <span className="truncate">Ver</span>
                                </button>

                                <div className="flex h-8 min-w-0 items-center justify-center gap-1.5 rounded-lg border border-amber-500/20 bg-amber-500/10 px-2 text-center">
