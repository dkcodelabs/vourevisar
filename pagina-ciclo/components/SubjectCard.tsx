...
const SubjectCard: React.FC<SubjectCardProps> = ({ subject, onCompleteSession, onOpenNotes, isActionable, isStudyFocus, viewMode, isExpanded, onToggleExpand, markedTopicIds, onToggleMark }) => {
    ...
    return (
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-md overflow-hidden flex flex-col">
        ...
        <div className="p-4 bg-gray-50 dark:bg-slate-800/50 flex-grow">
          <h4 className="font-semibold text-gray-700 dark:text-slate-300 mb-3 px-2">Tópicos concluídos:</h4>
        ...
        {isExpanded && (
          <div id={`topics-${subject.id}`} className="p-4 pt-0">
            <div className="p-4 bg-gray-50 dark:bg-slate-800/50 rounded-lg">
              <h4 className="font-semibold text-gray-700 dark:text-slate-300 mb-3 px-2">Tópicos para revisar:</h4>
  ...
  return (
    <div className={`${cardBaseClasses} flex flex-col ${focusClasses}`}>
      ...
      <div className="p-4 bg-gray-50 dark:bg-slate-800/50 flex-grow flex flex-col">
        <h4 className="font-semibold text-gray-700 dark:text-slate-300 mb-3 px-2 flex-shrink-0">Tópicos para revisar:</h4>
